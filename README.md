...
Offline habit tracker for [Flipper Zero](https://flipperzero.one/): streaks, a seven-day completion bar, configurable goals (default 66 days), and a gentle “did you complete this yesterday?” prompt so small slips do not erase progress.

## Features

- Dashboard with scrollable habits and a per-habit seven-day bar (filled = completed, frame = missed).
